...
const techStack = [
  ...
  },
  {
    ...
    name: "Shadcn",
    description: "Shadcn provided a collection of beautifully designed, accessible components that I customized to create a consistent and professional user interface. The component-based architecture allowed me to build complex UI elements quickly while maintaining full control over styling and functionality. I leveraged Shadcn's Radix UI primitives to ensure proper accessibility standards and keyboard navigation throughout the application."
  }
];
